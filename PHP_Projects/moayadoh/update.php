...
<html>
 <head>
  <title> Cars Trading - Update User Details </title>
...
?>
 ...
 <h2 align="center">Update Car Details</h2>
 <div align="center">
 Enter existing civil ID :
 <input type = "text" name="id">
 <br><br>
 <label>Owner name:</label>
 <input type = "text" name="owner" style="margin-left:70px;"><br>
 ...
 <br>
 <input type = "submit" value="Update" style="margin-left:80px;">
 ...
 <input type = "submit" value="Back" style="margin-left:80px;" onclick= "window.location.href='manage_account.php'">
  ...
  <?php
  $query = "update car set  owner = '$owner',model ='$model',color = '$color' ,price = '$price',type= '$type',mobile = '$mobile' where id = '$id'";
