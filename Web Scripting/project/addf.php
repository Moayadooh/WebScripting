<html>
<head>
<title> MUSCAT INTERNATIONAL AIRPORT : Add flight details</title>
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
 ...
 <label style="color:black;margin-left:30px;">DEPARTMENT</label><br>
...
<input type = "submit" value = "Add flight details">
 ...
 <?php
 $query = "INSERT INTO flight VALUES('$id','$name','$department','$flight_class','$flight_charges','$seats','$destination','$arrival')";
